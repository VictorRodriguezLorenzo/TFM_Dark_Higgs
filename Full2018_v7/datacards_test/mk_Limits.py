...
def run_commands(hs, DM, Zp):
    ...
    combine_cmd = f"combineCards.py higgs_sr_/evaluate_dnn_mhs_{hs}_mx_{DM}_mZp_{Zp}/datacard_DH_mhs_{hs}_mx_{DM}_mZp_{Zp}.txt " \
    ...
    combine_limit_cmd = f"combine -M AsymptoticLimits --run blind --expectSignal 1 --cminDefaultMinimizerStrategy 0 {root_filename} &> {limit_filename}"
