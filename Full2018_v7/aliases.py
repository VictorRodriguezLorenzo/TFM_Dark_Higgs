...
"""
# Normal DNN discriminator
aliases['evaluate_normal_dnn'] = {
                    'linesToAdd': [".L /afs/cern.ch/user/v/victorr/private/DarkHiggs/Full2018_v7/evaluate_DNN.cc+"],
                    'class' : 'evaluate_dnn',
                    'args': f'lep_pt1, lep_pt2, lep_eta1, lep_eta2, mll, mth, mtw1, mtw2, ptll, drll, dphill, PuppiMET_pt, detall, mpmet, recoil, mR, mT2, mTe, mTi, upara, uperp, dphilmet, dphillmet, mcoll, mcollWW, dPhillStar, dPhill_Zp, Cos_theta, Theta_ll, dPhill_MET, first_btag_ID, second_btag_ID'
                    }
"""
    ...
    for DM in mDM:
        for Zp in mZp:
            if DM == '300' and Zp in ['200', '300', '400', '500']:
                ...
                continue
            aliases['evaluate_rf_mhs_' + hs + '_mx_' + DM + '_mZp_' + Zp] = {
                    'linesToAdd': [".L /afs/cern.ch/user/v/victorr/private/DarkHiggs/Full2018_v7/evaluate_RF.cc+"],
                    'class' : 'evaluate_rf',
                    'args': f'lep_pt1, lep_pt2, lep_eta1, lep_eta2, mll, mth, mtw1, mtw2, ptll, drll, dphill, PuppiMET_pt, detall, mpmet, recoil, mR, mT2, mTe, mTi, upara, uperp, dphilmet, dphillmet, mcoll, mcollWW, dPhillStar, dPhill_Zp, Cos_theta, Theta_ll, dPhill_MET, first_btag_ID, second_btag_ID, {hs}, {Zp}, {DM}'
                    }
for hs in mhs:
    for DM in mDM:
        for Zp in mZp:
            if DM == '300' and Zp in ['200', '300', '400', '500']:
                ...
                continue
            aliases['evaluate_dnn_mhs_' + hs + '_mx_' + DM + '_mZp_' + Zp] = {
                    'linesToAdd': [".L /afs/cern.ch/user/v/victorr/private/DarkHiggs/Full2018_v7/evaluate_DNN.cc+"],
                    'class' : 'evaluate_dnn',
                    'args': f'lep_pt1, lep_pt2, lep_eta1, lep_eta2, mll, mth, mtw1, mtw2, ptll, drll, dphill, PuppiMET_pt, detall, mpmet, recoil, mR, mT2, mTe, mTi, upara, uperp, dphilmet, dphillmet, mcoll, mcollWW, dPhillStar, dPhill_Zp, Cos_theta, Theta_ll, dPhill_MET, first_btag_ID, second_btag_ID, {hs}, {Zp}, {DM}'
                    }
