#ifndef EVALUATE_RF_DARK_HIGGS
#define EVALUATE_RF_DARK_HIGGS
...
)
{
    ...
    PyObject* pModule = PyImport_ImportModule("EvaluateRF");
    ...
    if (pModule != NULL) {
        ...
        PyObject* pFunction = PyObject_GetAttrString(pModule, "load_random_forest_model");
        if (pFunction == NULL) {
...
//    cout << "Returning result RF: " << result << endl;
    return (float)result;
    Py_Finalize();
}
